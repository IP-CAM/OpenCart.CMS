        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <button type="button" id="button-url-filter" class="btn btn-primary pull-right"><i class="fa fa-filter"></i> <?php echo $button_filter; ?></button>
            </div>
          </div>
        </div>
            ...
            <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data">
              <div class="col-sm-6">
                <div class="form-group required">
                  <label class="control-label" for="input-query"><span data-toggle="tooltip" title="<?php echo $help_route; ?><?php echo $help_parameter; ?>"><?php echo $entry_query; ?></span>:</label>
...
<?php if ($error_query || $error_keyword_url) { ?>
	...
	if (hash != '#tab_seourl') {
		location.hash = '';
		location.href = location.href.replace('#', '') + '#tab_seourl';
	}
...
<?php if (isset($error_meta_h1[$language['language_id']]) || isset($error_meta_title[$language['language_id']]) || isset($error_meta_description[$language['language_id']]) || isset($error_meta_keyword[$language['language_id']])) { ?>
	...
	if (hash != '#tab_seotag') {
		location.hash = '';
		location.href = location.href.replace('#', '') + '#tab_seotag';
	}
