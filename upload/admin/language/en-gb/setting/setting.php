...
$_['entry_pro_href_admin']           = 'Link to admin panel';
...
$_['entry_seo_url_cache']            = 'Enable URLs cache';
$_['entry_seo_url_include_path']     = 'Friendly URL goods categories';
$_['entry_blog_full_path']           = 'URL blog with categories';
$_['entry_manufacturers_full_path']  = 'URL of the list of manufacturers with manufacturers';
$_['entry_seo_url_postfix']          = 'End Friendly URL';
$_['entry_valide_get_params_status'] = 'Exclude allowed get-parameters';
$_['entry_valide_get_params']        = 'Allowed get-parameters';
...
$_['help_pro_href_admin']            = 'Indicate the internal or external link of the admin panel for the button for quick editing of goods, if you changed the name of the folder on the server, for example: \'adminka/\' or \'https://site.by/adminka/\'. By default: \'admin/\'.';
...
$_['help_seo_url_cache']             = 'Enabling the cache URLs will reduce the load on the database. With a huge quantity of goods it is recommended to disconnect. <br /> (only for SeoPro)';
$_['help_seo_url_include_path']      = '/category/subcategory/product<br />(only for SeoPro)';
$_['help_blog_full_path']            = '/blog/category/subcategory<br />(only for SeoPro)';
$_['help_manufacturers_full_path']   = '/brands/manufacturer<br />(only for SeoPro)';
$_['help_seo_url_postfix']           = 'For example. html';
$_['help_valide_get_params_status']  = 'Disables call forwarding for the item from the allowed list of get-parameters (utm-tags).';
$_['help_valide_get_params']         = 'Each get-parameter from a new line.';
