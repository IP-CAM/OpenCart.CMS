...
$_['help_pro_href_admin']          = 'Indicate the internal link of the admin panel for the button for quick editing of goods, if you changed the name of the folder on the server, for example: \'adminka/\'. By default: \'admin/\'.';
