...
$_['help_seo_url_include_path']     = '/category/subcategory/product<br />(SeoPro only)';
$_['help_blog_full_path']           = '/blog/category/subcategory<br />(SeoPro only)';
$_['help_manufacturers_full_path']  = '/brands/manufacturer<br />(SeoPro only)';
