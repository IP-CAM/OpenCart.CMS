...
$_['text_blog_search']                 = 'Да, на всех страницах';
...
$_['entry_blog_menu']                  = 'Включить меню в шапке';
$_['entry_blog_search']                = 'Включить поиск в шапке';
...
$_['help_blog_menu']                   = 'Если да, то ссылки блога будут выведены в шапке сайта.';
$_['help_blog_search']                 = 'Если да, то на страницах блога стандартный поиск будет заменён на Поиск по блогу.';
