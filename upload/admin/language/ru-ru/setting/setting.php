...
$_['entry_bus_href_admin']             = 'Внутренняя ссылка админ панели';
...
$_['help_pro_href_admin']              = 'Укажите внутреннюю ссылку админ панели для кнопки быстрого редактирования товара, если изменяли название папки на сервере, например: \'adminka/\'. По-умолчанию: \'admin/\'.';
