...
$_['entry_pro_href_admin']           = 'Ссылка на админ панель';
...
$_['help_pro_href_admin']            = 'Укажите внутреннюю или внешнюю ссылку админ панели для кнопки быстрого редактирования товара, если изменяли название папки на сервере, например: \'adminka/\' или \'https://site.by/adminka/\'. По-умолчанию: \'admin/\'.';
...
$_['help_valide_get_params_status']  = 'Отключает переадресацию для товара из разрешенного списка get-параметров (утм-меток).';
