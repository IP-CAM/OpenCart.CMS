...
class ControllerExtensionModuleBusEditor extends Controller {
	...
	private $mame = 'Удобный Редактор - "Convenient Editor"';
	private $version = 'Pro';
...
function success() {
	...
	$('.alert-success').after('<a type="button" onclick="uninstallFilesPro();" class="btn btn-info alert" style="width:100%;" data-dismiss="alert"><i class="fa fa-trash-o"></i> $button_files_clear</a>');
	$('a, button, select, input').removeAttr('disabled');
}
